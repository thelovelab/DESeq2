...
\item Maximum \textit{a posteriori} estimation of dispersion replaces the \Rcode{sharingMode} options \Rcode{fit-only} or \Rcode{maximum} of the previous version of the package.
