...
The code to generate these results is in `simulateDE.R`.
...
```{r simulateDE, fig.width=7, fig.height=5, fig.align="center"}
library("ggplot2")
p <- ggplot(res, aes(y=sensitivity, x=oneminusspecpvals, color=algorithm, shape=algorithm))
...
```{r simulateDEPrec, fig.width=7, fig.height=5, fig.align="center"}
library("ggplot2")
...
```{r simulateOutliersSens, fig.width=8, fig.height=4, fig.align="center"}
library("ggplot2")
...
```{r simulateOutliersPrec, fig.width=8, fig.height=4, fig.align="center"}
p <- ggplot(res, aes(x=padj, y=oneminusprec, color=algorithm))
p + scale_x_continuous(breaks=c(0,.1,.2)) + 
  ...
  geom_point(aes(x=padj, y=oneminusprec, shape=algorithm),
             data=res[res$padj == .1,])
```
...
```{r lfcAccuracyHist, fig.width=8, fig.height=2.5, fig.align="center"}
...
```{r lfcAccuracy, fig.width=7, fig.height=5, fig.align="center"}
...
```{r lfcAccuracyDE, fig.width=6, fig.height=2.5, fig.align="center"}
...
```{r lfcAccuracyMAE, fig.width=7, fig.height=5, fig.align="center"}
...
```{r lfcAccuracyDiffMAE, fig.width=6, fig.height=2.5, fig.align="center"}
...
```{r simulateCluster, fig.width=8, fig.height=5, fig.align="center"}
