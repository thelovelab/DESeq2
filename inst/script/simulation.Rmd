...
Note: in the results *SAMseq* denotes running *SAMseq* with *p* value
estimation and Benjamini-Hochberg adjustment for FDR, while
...
library("ggplot2")
p <- ggplot(resClean, aes(y=sensitivity, x=oneminusspecpvals, color=algorithm, shape=algorithm))
...
myhist <- function(x, ...) hist(x, breaks=brks, border="white", col="blue", xlab="", ylab="", ...)
