...
Summary table of differences between methods available in `lfcShrink`
...
| Shrinks one coefficient at a time |  | ✓ | ✓ |
| Preserves "very large" LFC (doesn't overly shrink) |  | ✓ | ✓ |
| Explicitly designed to compute *s-values* [@Stephens2016] |  | ✓ | ✓ |
| Allows use of `coef` | ✓ | ✓ | ✓ |
| Allows use of `contrast` | ✓ |  | ✓ |
| Allows use of `lfcThreshold` (TODO) | ✓ | ✓ |  |
