...
* One can use the
  ...
  *zinbwave* and *DESeq2* package functions in the *zinbwave*
  vignette.
* The *apeglm* method for LFC shrinkage can be used in conjunction
  with *zinbwave* observation weights, because the weights are passed
  through to the *apeglm* functions. An example of such a workflow can
  be found at this
  [zinbwave-deseq2](https://github.com/mikelove/zinbwave-deseq2). GitHub repo.
...
* With single cell data, it is recommended to set the
  ...
  `DESeq`. This is also listed in the *zinbwave* vignette code.
