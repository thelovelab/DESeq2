...
only process $500000$ reads at a time. 

<<bamfilepaired>>=
library( "Rsamtools" )
bamLst <- BamFileList( bamFiles, yieldSize=500000 )
@ 
...
script from the \emph{HTSeq} Python package. Below we demonstrate using
\Rfunction{DESeqDataSetFromMatrix}.
